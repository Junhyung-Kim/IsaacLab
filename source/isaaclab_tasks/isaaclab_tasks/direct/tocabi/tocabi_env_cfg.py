...
@configclass
class TocabiFlatEnvCfg(DirectRLEnvCfg):
    # env
    episode_length_s = 12.0
    decimation = 5
    action_scale = 1.0
    action_space = 12
    observation_space = 48 # 3 + 3 + 3 + 3 + 33 + 33 + 12
    state_space = 0
...
@configclass
class TocabiRoughEnvCfg(TocabiFlatEnvCfg):
    # env
    ...
    height_scanner = RayCasterCfg(
        prim_path="/World/envs/env_.*/Robot/Pelvis_Link",
