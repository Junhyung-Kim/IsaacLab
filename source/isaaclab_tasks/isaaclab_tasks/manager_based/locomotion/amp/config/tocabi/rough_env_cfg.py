...
import isaaclab_tasks.manager_based.locomotion.amp.mdp as mdp
from isaaclab_tasks.manager_based.locomotion.amp.amp_env_cfg import AMPLocomotionRoughEnvCfg, RewardsCfg
...
@configclass
class TocabiRewards(RewardsCfg):
...
@configclass
class TocabiRoughEnvCfg(AMPLocomotionRoughEnvCfg):
